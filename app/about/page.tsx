      ...
      <section className="">
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
            ...
            <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 className="text-4xl tracking-tight font-extrabold"></h2>
                <p className="">
                  At EA CODES, we are dedicated to Crafting digital experiences that empower businesses to thrive in the online world. 
