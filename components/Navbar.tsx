    ...
    <nav className="bg-blue-900 fixed w-full top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 md:px-3 lg:px-12">
        <Link href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="/ealogo.png" className="h-8" alt="Company Logo" />
        ...
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isMenuOpen ? '' : 'hidden'}`} id="navbar-sticky">
          <ul className="flex flex-col items-center p-4 md:p-0 mt-4 font-medium border border-gray-900 dark:border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
