...
const Footer = () => {
  return (
    <footer className="rounded-lg shadow bg-gray-900 text-white m-4 p-5">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="grid grid-cols-1 sm:grid-cols-2">
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-8 sm:px-12'>
                <div>
                    <h2 className="font-bold text-lime-400">Links</h2>
                    <ul className="font-medium">
                        ...
                        <li>
                        <Button className='bg-white text-black hover:bg-lime-300'>
                ...
                <div>
                    <h2 className="font-bold text-lime-400">Legal</h2>
                    <ul className="font-medium">
                        <li className="my-2">
